		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Busca Imagens",
									"targetURL": "#ricardoimagesearch-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"ricardoimagesearch-display": {
								"semanticObject": "ricardoimagesearch",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=ricardo.imagesearch",
									"url": sap.ui.require.toUrl("ricardo/imagesearch")
								}
							}
						}
					}
